import bpy
from screen_space import BlenderRenderEngine, BlenderScene
...
camera_clip_far = scene.camera_near_far_clip()[1]
...
print(f"Camera far clip: {camera_clip_far}")
...
pixels = blender_render.render_coverage_luminance_depth_direction(
    ...
    camera_far_clip=camera_clip_far,
